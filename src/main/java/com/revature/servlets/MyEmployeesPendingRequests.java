...
/**
 * Servlet implementation class MyEmployeesPendingRequests
 */
public class MyEmployeesPendingRequests extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyEmployeesPendingRequests() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		requests = dao.getPendingRequestsByManager(username);
